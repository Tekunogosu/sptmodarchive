/* Mod page: turn the stacked sections into tabs.
 *
 * The panels are rendered by the build as ordinary sections, and this script
 * promotes them to a tablist. That ordering matters: if the script never runs,
 * the page is still complete -- just scrolled rather than tabbed -- and the
 * nav above it degrades to plain jump links, which is what those anchors are.
 *
